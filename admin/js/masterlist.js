...
const submit_barangay = () => {
  ...
  const myUrl = "http://localhost/waterbilling/admin/add_barangay.php";
  const formData = new FormData();
...
const submit_zone = () => {
  ...
  const myUrl = "http://localhost/waterbilling/admin/add_zone.php";
  const formData = new FormData();
...
const submit_property = () => {
  ...
  const myUrl = "http://localhost/waterbilling/admin/add_property.php";
  const formData = new FormData();
  ...
  axios({
    ...
    const submit_position = () => {
      ...
      const myUrl = "http://localhost/waterbilling/admin/add_position.php";
      const formData = new FormData();
    ...
    const submit_branch = () => {
      ...
      const myUrl = "http://localhost/waterbilling/admin/add_branch.php";
      const formData = new FormData();
    ...
    const submit_rates = () => {
      ...
      const myUrl = "http://localhost/waterbilling/admin/add_property_rate.php";
      const formData = new FormData();
  ...
  const add_employee = () => {
    ...
    const submit_employee = () => {
      ...
      const myUrl = "http://localhost/waterbilling/admin/add_employees.php";
      const formData = new FormData();
      formData.append("firstname", firstname);
      formData.append("middlename", middlename);
      formData.append("lastname", lastname);
    ...
    const getMunicipality1 = () => {
      ...
      var myUrl = "http://localhost/waterbilling/admin/get_municipality.php";
    ...
    const barangayUrl = `http://localhost/waterbilling/admin/get_barangay.php`;
    const formData = new FormData();
    ...
    const selectedBarangayId = document.getElementById("barangay").value;
      ...
      const zoneUrl = `http://localhost/waterbilling/admin/get_zone.php`;
      const formData = new FormData();
    ...
    var myUrl = "http://localhost/waterbilling/admin/get_position.php";
    ...
    const getProperty = () => {
      ...
      var myUrl = "http://localhost/waterbilling/admin/get_property.php";
    ...
    const getBranch = () => {
      ...
      var myUrl = "http://localhost/waterbilling/admin/get_branch.php";
