...
const getpoblacion = () => {
  ...
  // Fetch data from your PHP script
  fetch("http://localhost/128.199.232.132/admin/total_poblacion.php")
    .then((response) => response.json())
    .then((data) => {
      if (
        data &&
...
const getmolugan = () => {
  ...
  // Fetch data from your PHP script
  fetch("http://localhost/128.199.232.132/admin/total_molugan.php")
    .then((response) => response.json())
    .then((data) => {
      if (
        data &&
...
const getFileterBranch = () => {
  ...
  var myUrl = "http://localhost/128.199.232.132/admin/get_branch.php";
...
const displayActivity = () => {
  var url = "http://localhost/128.199.232.132/admin/activitylist.php";
