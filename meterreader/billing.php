        ...
        if ($rowRate) {
            ...
            for ($i = 1; $i <= $additional_units; $i++) {
                if ($i >= 1 && $i <= 10) {
                    ...
                    $new = $i - 20;
                    $bill_amount = $minimum_rate + ($second_rate * 10) + ($second_rate * 10) + ($third_rate * $new);
                } elseif ($i > 30) {
                    $new = $i - 30;
                    $bill_amount = $minimum_rate + ($second_rate * 10) + ($second_rate * 10) + ($third_rate * 10) + ($last_rate * $new);
                }
            }
