...
const onLoad = () => {
  ...
  const displayConsumer = () => {
    ...
    nextBtn.style.display = "block";
      ...
      var url = "http://152.42.243.189/waterworks/head/get_consumers.php";
...
// ----------------------------------FILTER POBLACION------------------------------------------------
  const displayConsumerPoblacion = () => {
          var url = "http://152.42.243.189/waterworks/head/get_consumers_poblacion.php";
          const formData = new FormData();
          formData.append("accountId", sessionStorage.getItem("accountId"));
          axios({
              url: url,
...
const submit_edit_consumer = (event, user_id) => {
  ...
  const myUrl = "http://152.42.243.189/waterworks/admin/update_api/update_consumer.php";
  const formData = new FormData();
  ...
  const updateBillStatus = () => {
    const myUrl = "http://152.42.243.189/waterworks/head/update_api/update_billstatus.php";
    const formData = new FormData();
...
// ----------------------------------FILTER MOLUGAN------------------------------------------------
      const displayConsumerMulogan = () => {
        var url = "http://152.42.243.189/waterworks/head/get_consumers_mulogan.php";
        const formData = new FormData();
        formData.append("accountId", sessionStorage.getItem("accountId"));
...
// ------------------------------------------------- CHANGE METER START --------------------------------------------------
      const change = (user_id) => {
        ...
        var myUrl = "http://152.42.243.189/waterworks/head/get_consumer.php";
        const formData = new FormData();
    ...
    const submit_change = (user_id) =>{
      ...
      if (new_meters === '' ) {
        ...
        const myUrl = "http://152.42.243.189/waterworks/head/change_meter.php";
        const formData = new FormData();
...
const submit_add = (user_id) =>{
  ...
  if (new_meters === '' ) {
    ...
    const myUrl = "http://152.42.243.189/waterworks/head/add_related.php";
    const formData = new FormData();
    formData.append("consumerId", user_id);
    formData.append("new_meters", new_meters);
    formData.append("employee_Id", sessionStorage.getItem("accountId"));
...
const more = (user_id) => {
  ...
  var myUrl = "http://152.42.243.189/waterworks/head/get_consumer_branch.php";
  const formData = new FormData();
  formData.append("accId", user_id);
...
const connected_edit = (user_id) => {
  ...
  var myUrl = "http://152.42.243.189/waterworks/head/get_connected_consumers.php";
  const formData = new FormData();
  formData.append("accId", user_id);
...
const submit_connected_update = (event, user_id) => {
  ...
  const myUrl = "http://152.42.243.189/waterworks/head/update_api/update_connected_consumer.php";
  const formData = new FormData();
  formData.append("userid", user_id);
  formData.append("firstname", firstname);
  formData.append("middlename", middlename);
